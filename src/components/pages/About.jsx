        ...
        <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
          ...
          <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
            ...
            >
              <img
                alt=""
                className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full border-2 border-blue-500"
                src={profile3}
              />
              ...
              <div className="flex items-center justify-center p-3 space-x-3 border-t-2 border-blue-500">
                <a
                  ...
                  href="#"
                  title="Email"
                  className="dark:text-blue-500 hover:scale-150 transition ease-in-out"
                >
                  <svg
